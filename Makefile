...
# Shared Files
COMM_SRC = communication/message.c
COMM_OBJ = $(COMM_SRC:.c=.o)

STOR_SRC = storage/datastorage.c
STOR_OBJ = $(STOR_SRC:.c=.o)
...
$(CLIENT_TARGET): $(CLIENT_OBJ) $(COMM_OBJ) $(STOR_OBJ)
	$(CC) $(CLIENT_OBJ) $(COMM_OBJ) $(STOR_OBJ) -o $(CLIENT_TARGET)

# Linking Server: Needs its own .o and the shared .o
$(SERVER_TARGET): $(SERVER_OBJ) $(COMM_OBJ) $(STOR_OBJ)
	$(CC) $(SERVER_OBJ) $(COMM_OBJ) $(STOR_OBJ) -o $(SERVER_TARGET)
